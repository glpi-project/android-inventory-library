...
# move code coverage
mv -v inventory/build/reports/coverage development

# move Android test
mv -v inventory/build/reports/androidTests development
...
javadoc -d ./development/code-documentation -sourcepath ./inventory/src/main/java -subpackages . -nonavbar
